...
* [Configuración de proyecto](#proyecto)
	* [Instalación de dependenias utilizando Composer](#composer)
...
Ejemplo sencillo utilizando el Framework php, **Flight PHP** para crear una **Api REST** con el gestor de base de datos MySql.
...
* Composer
* Mysql
* Flight PHP [Repositorio](https://github.com/mikecao/flight)

[Contenido](#contenido)

<a name="repositorio"></a>
## Descarga de repositorio
Primero clonamos projecto
```bash
# SSH
...
<a name="composer"></a>
### Instalación de dependenias utilizando Composer
...
Para importar script sql al gestor de base de datos MySql, lo podemos realizar mediante PhpMyAdmin, workbeanch o desde la linea de comando. El siguiente comando importa el script sql a MySql desde la linea de comandos
...
```
Para realizar la operación inversa usaremos el siguente comando
```bash
# Sintaxis
...
Abrimos el proyecto en nuestro editor de codigo de preferencia
```bash
# Accedermos al proyecto
cd FlightPHP-Api-REST-TodoList
# Abrimos el proyecto con Visual Studio Code
code .
# O tambien podemos abrirlo con sublime text
subl .
```

Editamos el archivo de configuración las credenciales de MySql ```./Config.php```

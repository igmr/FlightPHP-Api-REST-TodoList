...
CREATE TABLE IF NOT EXISTS Lists (
    ...
    CONSTRAINT uk_id_list    UNIQUE(id ASC),
    CONSTRAINT uk_name_list  UNIQUE(name ASC)
)ENGINE = InnoDB
COMMENT = 'Lists';
...
CREATE TABLE IF NOT EXISTS Tasks (
    ...
    CONSTRAINT uk_id_tasks     UNIQUE(id ASC),
...
VALUES
    ...
    (2, '3.5. Prueba de lectura de variables de entorno'
        , NULL, true, NOW()),
    (2, '4. Crear archivo de configuracion en /App/Config/Config.php'
        , NULL, true, NOW()),
    (2, '5. CORS'
        , NULL, true, NOW()),
